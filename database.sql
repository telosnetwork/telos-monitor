...
CREATE TABLE task_status(id SERIAL PRIMARY KEY, task INT NOT NULL, message VARCHAR(255), type INT NOT NULL, FOREIGN KEY (task) REFERENCES tasks(id), FOREIGN KEY (type) REFERENCES task_status_type(id));
INSERT INTO task_status_type (name) VALUES ('info'), ('alert'), ('error');